...
```{r 1_summary, eval=TRUE, warning=FALSE, message=FALSE}
...
```{r 2_variation, warning=FALSE, message=FALSE}
library("tidyverse")
library("skimr")
...
```{r 3_missing, warning=FALSE, message=FALSE}
library("nycflights13")
library("tidyverse")
...
```{r 4_covariation, eval=TRUE, warning=FALSE, message=FALSE}
library("nycflights13")
library("lvplot")
library("ggbeeswarm")
library("gridExtra")
...
```{r 4_1_1_covariation, echo=TRUE, eval=FALSE}
flights2 <- flights |>
  mutate(
...
```{r 4_1_5_covariation, fig.height=8, fig.width=8}
#geom_freqpoly()
...
```{r 4_1_6_covariation, fig.height=8, fig.width=8}
#get a small dataset
set.seed(123)
...
```{r 4_2_3_covariation, fig.height=8, fig.width=8}
#simple plot
flights |>
  group_by(month, dest) |>
  summarise(
...
```{r 4_3_1_covariation, echo=TRUE, eval=FALSE}
?cut_interval()
...
```{r 4_3_6_covariation, echo=TRUE, eval=TRUE}
diamonds |> 
...
```{r 5_patterns, eval=TRUE, warning=FALSE, message=FALSE}
library("tidymodels")
library("tidyverse")
