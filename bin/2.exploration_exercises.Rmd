...
c\) The travel distance to airport "EGE" has no zero spread in the database. Create a plot to further explore the adventures of EGE. Can you find any evidence that the airport moved locations?
```{r 1_3_summary}
#check spread of distance to airport "EGE"
flights |> 
  filter(dest == "EGE") |>
  group_by(origin) |> 
  summarize(
...
```{r 4_1_4_covariation, fig.height=8, fig.width=8}
#geom_freqpoly()
...
```{r 4_3_5_covariation, echo=TRUE, eval=TRUE}
diamonds |> 
